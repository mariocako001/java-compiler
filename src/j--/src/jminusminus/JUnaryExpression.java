...
/**
 * The AST node for an expr-- expression.
 */
 ...
 * The AST node for an expr++ expression.
 */
// Copied the code from JPostDecrementOp and commented
// out the codegen and analyze block
...
class JNotOp extends JUnaryExpression {
    ...
    /**
     * Construct an AST node for a complement expression given its line number,
     * and the operand.
     * 
     * @param line
...
/**
 * The AST node for a --pre expression.
 */
