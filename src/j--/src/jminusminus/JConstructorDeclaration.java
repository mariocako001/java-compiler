...
class JConstructorDeclaration extends JMethodDeclaration implements JMember {
    ...
    public JConstructorDeclaration(int line, ArrayList<String> mods,
            String name, ArrayList<JFormalParameter> params, ArrayList<TypeName> qualIdentifier , JBlock body)

    {
        super(line, mods, name, Type.CONSTRUCTOR, params, qualIdentifier, body);
    }
