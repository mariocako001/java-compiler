...
class JMethodDeclaration
    ...
    /** Exception that handles throws */
    protected ArrayList<TypeName> qualIdentifier;
    ...
    public JMethodDeclaration(int line, ArrayList<String> mods,
        ...
        ArrayList<JFormalParameter> params, ArrayList<TypeName> qualIdentifier, JBlock body)

    {
        ...
        this.params = params;
        this.qualIdentifier = qualIdentifier;
        this.body = body;
...
// hw3 added
        ...
        p.indentRight();
        if(qualIdentifier != null){
            for(TypeName t : qualIdentifier){
                p.indentRight();
