...
class JClassDeclaration extends JAST implements JTypeDecl {
    ...
    /** Implements list */
    private ArrayList<TypeName> implementsTypeNameList;

    /** Implemets only one */
    private TypeName implementsTypeName;
    ...
    public JClassDeclaration(int line, ArrayList<String> mods, String name,
            Type superType, ArrayList<TypeName> implementsTypeNameList ,ArrayList<JMember> classBlock) {
        super(line);
        this.mods = mods;
        this.name = name;
        this.superType = superType;
        this.classBlock = classBlock;
        this.implementsTypeNameList = implementsTypeNameList;
 ...
 public JClassDeclaration(int line, ArrayList<String> mods, String name,
            Type superType, TypeName implementsTypeName ,ArrayList<JMember> classBlock) {
        super(line);
        this.mods = mods;
        this.name = name;
        this.superType = superType;
        this.classBlock = classBlock;
        this.implementsTypeName = implementsTypeName;
        hasExplicitConstructor = false;
        instanceFieldInitializations = new ArrayList<JFieldDeclaration>();
        staticFieldInitializations = new ArrayList<JFieldDeclaration>();
    }
    ...
    public void writeToStdOut(PrettyPrinter p) {
        ...
        if (implementsTypeNameList != null) {
             p.println("<Implements>");
             p.indentRight();
             for (TypeName param : implementsTypeNameList) {
                 p.printf("<Implementing name=%s>\n", param.toString());
             }
             p.indentLeft();
             p.println("</Implements>");
        }

        if (implementsTypeName != null) {
             p.println("<Implements>");
             p.indentRight();
                 p.printf("<Implementing name=%s>\n", implementsTypeName.toString());
             p.indentLeft();
             p.println("</Implements>");
        }
